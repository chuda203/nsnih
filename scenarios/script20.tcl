# ===== SCENARIO 20 =====
# Keterangan  : Peak stabil
# Tipe        : Wired + Wireless (3 AP)
# Jumlah Node : 300 wireless nodes
# Routing     : AODV
# Queue       : RED
# Traffic     : TCP + UDP
# Rate        : 1 Mbps
...
set tracefile [open logs/s20.tr w]
$ns trace-all $tracefile

set namfile [open visuals/s20.nam w]
...
# Wireless nodes: 300 clients + 3 AP wired nodes = 303 total
set num_wl_nodes 300
...
# ---- Associate wireless nodes to APs (100 each) ----
...
$tcp1 set fid_ 2
$ns attach-agent $wl(30) $tcp1
set sink1 [new Agent/TCPSink]
$ns attach-agent $wl(269) $sink1
...
$tcp2 set fid_ 3
$ns attach-agent $wl(60) $tcp2
set sink2 [new Agent/TCPSink]
$ns attach-agent $wl(239) $sink2
...
$udp0 set fid_ 4
$ns attach-agent $wl(90) $udp0
set null0 [new Agent/Null]
$ns attach-agent $wl(209) $null0
$ns connect $udp0 $null0
set cbr0 [new Application/Traffic/CBR]
$cbr0 set packetSize_ 1024
$cbr0 set interval_   0.0082
$cbr0 attach-agent $udp0

set udp1 [new Agent/UDP]
$udp1 set fid_ 5
$ns attach-agent $wl(120) $udp1
set null1 [new Agent/Null]
$ns attach-agent $wl(179) $null1
$ns connect $udp1 $null1
set cbr1 [new Application/Traffic/CBR]
$cbr1 set packetSize_ 1024
$cbr1 set interval_   0.0082
$cbr1 attach-agent $udp1

set udp2 [new Agent/UDP]
$udp2 set fid_ 6
$ns attach-agent $wl(150) $udp2
set null2 [new Agent/Null]
$ns attach-agent $wl(149) $null2
$ns connect $udp2 $null2
set cbr2 [new Application/Traffic/CBR]
$cbr2 set packetSize_ 1024
$cbr2 set interval_   0.0082
