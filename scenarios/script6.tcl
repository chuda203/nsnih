...
set tracefile [open logs/s6.tr w]
$ns trace-all $tracefile

set namfile [open visuals/s6.nam w]
...
# ---- TCP Traffic flows (512 Kbps, 1024B packets) ----
...
# interval = 1024 / 65536 = 0.015625 s
set udp0 [new Agent/UDP]
$udp0 set fid_ 3
$ns attach-agent $wl(60) $udp0
set null0 [new Agent/Null]
$ns attach-agent $wl(239) $null0
$ns connect $udp0 $null0
set cbr0 [new Application/Traffic/CBR]
$cbr0 set packetSize_ 1024
$cbr0 set interval_   0.015625
$cbr0 attach-agent $udp0

set udp1 [new Agent/UDP]
$udp1 set fid_ 4
$ns attach-agent $wl(90) $udp1
set null1 [new Agent/Null]
$ns attach-agent $wl(209) $null1
$ns connect $udp1 $null1
set cbr1 [new Application/Traffic/CBR]
$cbr1 set packetSize_ 1024
$cbr1 set interval_   0.015625
