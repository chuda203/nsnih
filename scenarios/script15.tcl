...
set tracefile [open logs/s15.tr w]
$ns trace-all $tracefile

set namfile [open visuals/s15.nam w]
...
$udp1 set fid_ 4
$ns attach-agent $wl(75) $udp1
set null1 [new Agent/Null]
$ns attach-agent $wl(174) $null1
