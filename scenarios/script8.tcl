...
# ---- UDP Traffic flows - Streaming padat (512 Kbps, 1024B packets) ----
...
$cbr2 set interval_   0.015625
$cbr2 attach-agent $udp2

set udp3 [new Agent/UDP]
$udp3 set fid_ 4
$ns attach-agent $wl(60) $udp3
set null3 [new Agent/Null]
$ns attach-agent $wl(139) $null3
$ns connect $udp3 $null3
set cbr3 [new Application/Traffic/CBR]
$cbr3 set packetSize_ 1024
$cbr3 set interval_   0.015625
